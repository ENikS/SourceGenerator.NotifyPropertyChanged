...
namespace SourceGenerator.NotifyPropertyChanged
{
    public partial class PropertyGenerator
    {
        private sealed class Parser
        {
            ...
            //public ClassDeclarationModel[] GetEventSourceClasses(IList<ClassDeclarationSyntax> classDeclarations)
            //{
            //    INamedTypeSymbol? autogenerateAttribute = _compilation.GetTypeByMetadataName(typeof(NotifyPropertyChangedAttribute).FullName);
            //    if (autogenerateAttribute is null)
            //    {
            //        // No EventSourceAutoGenerateAttribute
            //        return Array.Empty<ClassDeclarationModel>();
            //    }
            ...
            //    List<ClassDeclarationModel>? results = null;
            ...
            //        ClassDeclarationModel? eventSourceClass = null;
            //        foreach (ClassDeclarationSyntax? classDef in group)
            //        {
            //            if (_cancellationToken.IsCancellationRequested)
            //            {
            //                // be nice and stop if we're asked to
            //                return results?.ToArray() ?? Array.Empty<ClassDeclarationModel>();
            //            }
            ...
            //                        eventSourceClass = new ClassDeclarationModel
            //                        {
            //                            Namespace = nspace,
            //                            ClassName = className,
            //                            SourceName = name,
            ...
            //            results ??= new List<ClassDeclarationModel>();
